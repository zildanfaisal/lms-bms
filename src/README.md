# Install Laravel Learning Management System

Project ini dibangun menggunakan **Laravel 12 + TailwindCSS**.

## Cara Install Project LMS

1. Clone repository:
    ```bash
    git clone https://github.com/zildanfaisal/lms-bms.git
    ```
    ```bash
    cd lms-bms/src
    ```
...
3. Install depedency JS dengan NPM
    ...
    npm install
    ```
4. Buat database dengan nama lms-bms
...
9. Masukkan data ke database dengan Seeder (optional)
    ...
    php artisan db:seed
    ```  
10. Selesai, selamat anda telah berhasil install project Learning Management System.
