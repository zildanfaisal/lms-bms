...
@section('header')
    <h1 class="text-xl font-semibold text-gray-800">Tambah Posisi</h1>
@endsection
        ...
        <form action="{{ route('posisi.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="nama_posisi" value="{{ old('nama_posisi') }}" class="mt-1 block w-full rounded border-gray-200" required>
                </div>
